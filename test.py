...
def test(encoder, loader, img_size, map_size, int_to_char, char_to_int, beam_size, device, lm_scorer):
    ...
    for sample in loader:
        ...
        pred = beam_decode(probs, beam_size, int_to_char, char_to_int, digit=True, scorer=lm_scorer, beta = 0.05, gamma = 0.3)
        #beam_decode_old(probs, beam_size, int_to_char, char_to_int, digit = True)
